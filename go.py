...
class LibertyTracker():
    ...
    def __init__(self, group_index=None, groups=None, liberty_cache=None, max_group_id=1):
        ...
        self.group_index = group_index if group_index is not None else -np.ones([N, N], dtype=np.int64)
...
class Position():
    def __init__(self, board=None, n=0, komi=6.5, caps=(0, 0), lib_tracker=None, ko=None, recent=tuple(), to_play=BLACK):
        '''
        board: a numpy array
